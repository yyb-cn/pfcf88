...
if(file_exists(APP_ROOT_PATH.'system/payment/Sqepay_payment.php'))
{
	require_once APP_ROOT_PATH.'system/payment/Sqepay_payment.php';
	
	$p_obj = new Sqepay_payment();
	$p_obj->adminquery($payment_notice_id);
}*/
