...
?>
				...
				<div class="blank"></div>
				<?php endif; ?>			
            <div style="padding-top:25px; padding-left:200px; float:left;">    
            <a  href=""  target="_blank"><img src="<?php echo $this->_var['TMPL']; ?>/images/ssl_norton.png" onmouseover="this.src='<?php echo $this->_var['TMPL']; ?>/images/ssl_nortonx.png'" onmouseout="this.src='<?php echo $this->_var['TMPL']; ?>/images/ssl_norton.png'" /></a>
            <a  href=""  target="_blank"><img src="<?php echo $this->_var['TMPL']; ?>/images/ssl_360safe.png" onmouseover="this.src='<?php echo $this->_var['TMPL']; ?>/images/ssl_360safex.png'" onmouseout="this.src='<?php echo $this->_var['TMPL']; ?>/images/ssl_360safe.png'" /></a>
            <a  href=""  target="_blank"><img src="<?php echo $this->_var['TMPL']; ?>/images/logo_szfw.png" onmouseover="this.src='<?php echo $this->_var['TMPL']; ?>/images/logo_szfwx.png'" onmouseout="this.src='<?php echo $this->_var['TMPL']; ?>/images/logo_szfw.png'" /></a>
            </div>
	        <div class="copyright"> 
