...
<!--条件搜索开始-->  
<!--    
<link  rel="stylesheet"  href="<?php echo $this->_var['TMPL']; ?>/css/deals.css">
<script  type="text/javascript"  src="<?php echo $this->_var['TMPL']; ?>/js/deals.js"></script>

    <div class="deals_ss">
<div  class="list-left-navigation m-border fn-bb kf-mb20">
<div  class="main-title kf-mt10 fn-clear">

</div>
<div  class="navigation-item kf-mb10 kf-mt10">
<div  class="navigation-title fn-left">
<span  class="kf-ml15" style="margin:0 0 0 15px; text-align:right;">投资利率：</span>
</div>
<ul  class="navigation-pro fn-clear"  id="pro-money-select">
<li><a  href="javascript:;"  data-max=""  class="mcur">全部</a></li>
<li><a  href="javascript:;"  data-max="5"  class="" >6%以上</a></li>
<li><a  href="javascript:;"  data-min="5">9%以上</a></li>
<li><a  href="javascript:;"  data-min="5">12%以上</a></li>

</ul>
</div>
<div  class="navigation-item kf-mb10"><div  class="navigation-title fn-left">
<span  class="kf-ml15">投资期限：</span>
</div>
<ul  class="navigation-pro fn-clear"  id="pro-time-select">
<li><a  href="javascript:;"  data-max=""  class="tcur">全部</a></li>
<li><a  href="javascript:;"  data-max="12">3个月</a></li>
<li><a  href="javascript:;"  data-min="12">6个月</a></li>
<li><a  href="javascript:;"  data-min="12">9个月</a></li>
<li><a  href="javascript:;"  data-min="12">12个月</a></li>
</ul>
</div>
...
?></span></div>
				...
				<div class="f_dgray b tc" style="height:40px;line-height:40px; padding-left:20px;">
				 ...
				 <?php endif; ?>
				<div class="biao-list clearfix" id="J_biao_list" style="padding-left:20px;">
...
?>%;"></div></div>
			        ...
			        </div><div style="float:right; width:96px; height:36px;">
				<?php if ($this->_var['deal']['deal_status'] == 1): ?>
            <a style="background:none; border:none; padding:0px" href="<?php echo $this->_var['deal']['url']; ?>" class="btn-orange"><img style=" width:80px; height:80px;" src="<?php echo $this->_var['TMPL']; ?>/images/load.png" alt="" width="111px" height="34px"></a>
            <?php elseif ($this->_var['deal']['deal_status'] == 2): ?><!--满标-->
			<a style="background:none; border:none; padding:0px" href="javascript:;" class="btn-orange"><img style=" width:80px;height:80px;" src="<?php echo $this->_var['TMPL']; ?>/images/load_full.png" alt="" width="111px" height="34px"></a>
            <?php elseif ($this->_var['deal']['deal_status'] == 4): ?><!--还款中-->
            <a style="background:none; border:none; padding:0px" href="javascript:;" class="btn-orange"><img style=" width:80px;height:80px;" src="<?php echo $this->_var['TMPL']; ?>/images/load_in_progress.png" alt="" width="111px" height="34px"></a>
            <?php elseif ($this->_var['deal']['deal_status'] == 5): ?><!--已还清-->
            <a style="background:none; border:none; padding:0px" href="javascript:;" class="btn-orange"><img style=" width:80px;height:80px;" src="<?php echo $this->_var['TMPL']; ?>/images/load_done.png" alt="" width="111px" height="34px"></a>
             <?php endif; ?>
			</div>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
