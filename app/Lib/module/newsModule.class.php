...
class newsModule  extends SiteBaseModule {
    ...
    private function cate(){
		...
		if (!$GLOBALS['tmpl']->is_cached('page/news_index.html', $cache_id))	
		{	
			...
			//行业新闻
			$news_list  = get_article_list(6,21);
		...
		$GLOBALS['tmpl']->display("page/news_index.html",$cache_id); 
    }
    ...
    private function view(){
		...
		if (!$GLOBALS['tmpl']->is_cached("page/news_view.html", $cache_id))
		{	
		...
		$GLOBALS['tmpl']->display("page/news_view.html",$cache_id);
    }
}
?>